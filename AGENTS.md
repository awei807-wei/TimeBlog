...
当前站点版本：`2026@09·11`。版本格式为“年份@月份·当月修改序号”；同月每次用户可见改动递增末位序号，跨月后从 `1` 重新计数。显示实现位于 `apps/web/app/layout.tsx`，文档与页面必须保持一致。
...
- 2026-09-23：修正数字资产甘特图在起止日期靠近月界时首尾日期与月度刻度标签重叠的问题，按实际轨道像素间距过滤过近刻度；站点版本更新为 `2026@09·11`。
- 2026-09-23：在公开日历下方新增仅登录管理员可见的数字资产到期甘特图与完整新增、编辑、删除管理，补充 UTC 日期范围、续费详情、认证门控和管理员响应无缓存复核；站点版本更新为 `2026@09·10`。
...
- 2026-09-11：恢复 Markdown 有序、无序列表标记并区分嵌套层级；站点版本更新为 `2026@09·6`。
- 2026-09-11：清除 Novel 正文编辑容器的水平自动外边距；站点版本更新为 `2026@09·5`。
- 2026-09-11：清除 Novel 正文编辑容器在桌面端和移动端的内边距；全站页面右下角增加月度修改版本号 `2026@09·4`。
