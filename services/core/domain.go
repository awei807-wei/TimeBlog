...
type memoryMFAChallenge struct {
...
type Store struct {
	...
	userPassword     string
	userTOTP         string
	mfaChallenges    map[string]memoryMFAChallenge
	authOperations   map[string]memoryAuthOperation
