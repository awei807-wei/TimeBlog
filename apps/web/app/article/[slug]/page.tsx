...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main id="main-content" className="shell article-shell">
      <header className="topbar"><Link href="/" className="brand">个人时间线</Link><nav className="nav"><Link href="/calendar">日历</Link><Link href="/search">搜索</Link><Link href="/admin">写作</Link></nav></header>
